...
var chunk_QRAGQZ4B_exports = {};
__export(chunk_QRAGQZ4B_exports, {
  GetDmmfError: () => GetDmmfError,
  getDMMF: () => getDMMF
});
module.exports = __toCommonJS(chunk_QRAGQZ4B_exports);
...
[Context: getDmmf]`;
    super((0, import_chunk_E46MMN3S.addVersionDetailsToErrorMessage)(errorMessageWithContext));
  ...
  const dmmfPipeline = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        const data = import_chunk_EEYJ3IWX.prismaSchemaWasm.get_dmmf(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
